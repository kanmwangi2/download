...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Cheetah Payroll has been fully migrated to use Supabase as its exclusive cloud backend. All operational and global data (staff, payroll, payment types, users, companies, tax settings, audit logs, etc.) is securely stored in Supabase PostgreSQL. No data is stored locally in your browser - everything is cloud-native and accessible from any device with your credentials. All seeded data is initialized in Supabase with real-time synchronization across all user sessions. To reset your company or user data, contact your system administrator or use the provided admin tools in the application settings (if available).",
  },
  {
