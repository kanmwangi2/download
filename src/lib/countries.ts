...
// A list of countries for select dropdowns
// Source: A combination of common lists, ISO 3166-1 alpha-2 codes can be used for values if needed for backend.
// For simplicity here, value and label are the same.
